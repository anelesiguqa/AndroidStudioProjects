...
public class MainCoursesActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Dish[] mainDishes = {new Dish("Thai basil and mulberry salad", "A crisp salad featuring fresh thai basil and mulberry", 1499),
        ...
        ArrayAdapter<Dish> mainDishesAdapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, mainDishes);
